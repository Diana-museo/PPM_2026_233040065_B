...
void main() {
  runApp(const TugasMandiri()); // Mengubah nama project (Requirement 0)
}
...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // 2. Mengubah background menjadi warna soft (Requirement 2)
      ...
      drawer: Drawer(
        ...
        child: ListView(
          children: [
            ...
            // 5. Drawer Pengaturan dengan AlertDialog (Requirement 5)
            ListTile(
              ...
              onTap: () {
                ...
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    title: const Text('Pengaturan'),
                    content: const Text('Halaman pengaturan sedang dalam perbaikan.'),
                    actions: [
                      TextButton(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Column(
                children: [
                  // 1. CircleAvatar dengan foto dari assets (Requirement 1)
                  const CircleAvatar(
                    radius: 50,
            ...
            const _SectionCard(
              ...
              content: 'Coding • Membaca • Fotografi • Game • Melukis • Menyanyi • Bikin meme',
            ),
            const _SectionCard(
              icon: Icons.email,
              title: 'Contact',
              content: 'emeralda.dianaxxiv@gmail.com\n+62 896-3826-8193',
            ),

            // 3. Section Card Skills dengan Wrap & Chips (Requirement 3)
            Card(
              color: Colors.white,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      runSpacing: 4,
                      children: const [
                        Chip(label: Text('PHP'), backgroundColor: Color(0xFFE2ECF6)),
                        Chip(label: Text('Java'), backgroundColor: Color(0xFFE2ECF6)),
                        Chip(label: Text('Python'), backgroundColor: Color(0xFFE2ECF6)),
                        Chip(label: Text('Flutter'), backgroundColor: Color(0xFFE2ECF6)),
                        Chip(label: Text('UI/UX'), backgroundColor: Color(0xFFE2ECF6)),
                      ],
                    ),
                  ],
                ),
      ...
      // 4. FAB dengan SnackBar (Requirement 4)
      ...
      // 6. Mengganti ke NavigationBar Material 3 (Requirement 6)
      bottomNavigationBar: NavigationBar(
        backgroundColor: Colors.white, // Warna background bar-nya
        indicatorColor: const Color(0xFFC6D6E6), // Warna di belakang icon aktif
        selectedIndex: 1,
...
// --- BAGIAN DIBAWAH INI TETAP SAMA SEPERTI CODING ANDA ---
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Icon(icon, color: Color(0xFF6887A6), size: 28),
